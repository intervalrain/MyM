...
using MyMoney.TestCommon.TestUtilities.NSubstitute;
...
public class AuthorizationBehaviorTests
{
    ...
    {
        // Arrange
        var request = new RequestWithNoAuthorizationAttribute(Constants.User.UserId);
    ...
    {
        // Arrange
        var request = new RequestWithSingleAuthorizationAttribute(Constants.User.UserId);
    ...
    {
        // Arrange
        var request = new RequestWithTonsOfAuthorizationAttribute(Constants.User.UserId);
...
public record RequestWithNoAuthorizationAttribute(Guid UserId) : MyMoney.Application.Common.Security.Request.IAuthorizeableRequest<ErrorOr<Response>>;

[Authorize(Permissions = "Permission")]
public record RequestWithSingleAuthorizationAttribute(Guid UserId) : MyMoney.Application.Common.Security.Request.IAuthorizeableRequest<ErrorOr<Response>>;
...
public record RequestWithTonsOfAuthorizationAttribute(Guid UserId) : MyMoney.Application.Common.Security.Request.IAuthorizeableRequest<ErrorOr<Response>>;